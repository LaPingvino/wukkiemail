...
- Status as of now: filter core + search wiring landed. NOT yet built: the bundled stream UI, config bundle, manual-bundle CRUD, sidebar removal. Do these next, incrementally, each build-verified.
